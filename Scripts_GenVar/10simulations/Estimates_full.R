...
full.sample <- matrix(as.numeric(scan(paste0("Sample", REP, "_full.txt"), what = "numeric")), nrow = 10500)
...
for(year in 16:21){
  ...
  save(Parents.Genetic.var, Parents.Genic.var, F1.Genetic.var, F1.Genic.var, 
       ...
       file = paste0("./Simulation", simulation, "/fullBayes/estimates.fullBayes_year", year, REP, ".RData"))
}
